...
"""
1. Una accion en forma de string:
...
def inventario(accion: str, registro = {}):
    try:
        def inicializarAlmacenamiento(data):
            global almacenamiento

            try:
                almacenamiento = eval(str(data))
            except:
                print("Hubo un error con la carga del archivo")
                print("Se inicializará el inventario vacío")

                reinicializarAlmacenamiento()

        def reinicializarAlmacenamiento():
            global almacenamiento
        ...
        if accion == "reinicio":
            ...
            inicializarAlmacenamiento(registro)
